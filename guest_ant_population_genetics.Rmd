...
### Table of ant IDs and longitude/latitudes

Write a table that has all of the ants, their site and nest information, and locations.
...
ids_lats_lons %>%
  ...
  rename("Ant ID" = id,
         ...
         "Longitude" = lon,
         "Latitude" = lat) %>%
  write_csv(here("tables", "ant_ids_and_locs.csv"))
```