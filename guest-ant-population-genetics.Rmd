...
amova_df %>%
  kbl(caption="AMOVA results", format = "html", table.attr = "style='width:100%;'") %>%
  kable_styling(position = "left")
```
...
# haplotypes <- haplotypes %>%
#   left_join(., sites[2:3], by=c("site" = "site")) %>%
#   select(site, name, starts_with("HAP"))
# 
# write.csv(haplotypes, "post-review-tables/table_4_mitochondrial_haplotypes.csv", row.names=FALSE)
```
